...
public interface UserProfileMapper {
    ...
    int insertUserProfile(@Param("id") String id, @Param("password") String password, @Param("name") String name, @Param("createTime") String createTime, @Param("updateTime") String updateTime);
    ...
    int regist(UserDTO userProfile);
}
